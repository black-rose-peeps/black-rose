...
function doubleEliminationBracketRules(teamCap: number | undefined, solo: boolean): RuleSection {
  ...
  return {
    ...
    items: [
      ...
      "Lower bracket progresses through numbered rounds, then Lower Quarterfinals (e.g. rounds 6–7) and Lower Semifinals (e.g. rounds 8–9) on larger fields, before the Grand Final.",
