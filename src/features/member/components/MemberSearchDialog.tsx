    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl gap-0 overflow-hidden rounded-none border-white/12 bg-[oklch(0.08_0_0)] p-0 shadow-2xl shadow-black/40">
        <div className="border-b border-white/8 px-5 py-4">
          ...
          <p className="mt-0.5 font-display text-xl tracking-display text-foreground">
            Find a member
          </p>
        </div>
            ...
            {!hasQuery ? (
              <div className="px-4 py-3">
                <ArenaEmptyState
                  ...
                  description="Search the verified roster by display name or Discord handle."
              ...
              <div className="px-4 py-3">
                <ArenaEmptyState
                  ...
                  description={`No verified member matches "${search.trim()}". Try a different spelling or their Discord handle.`}
                  actions={
                    <button
                      type="button"
                      onClick={() => setSearch("")}
              ...
              >
                {results.map((member) => (
                  <CommandItem
                    ...
                    className={cn(
                      "cursor-pointer rounded-none px-3 py-3 aria-selected:bg-white/6",
