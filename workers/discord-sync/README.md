...
- **Member priority:** each run checks newest `Not Verified` members first (`created_at` desc), then fills remaining batch slots with `Verified` members for ROSE-removal checks.
